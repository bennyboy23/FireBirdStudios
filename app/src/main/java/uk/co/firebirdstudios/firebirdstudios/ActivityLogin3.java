...
public class ActivityLogin3 extends ActionBarActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, View.OnClickListener {
    ...
    public void onConnected(Bundle connectionHint) {
        ...
        new GetTokenInBackground().execute();
    ...
    private class GetTokenInBackground extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... params) {
            try {
                GoogleAuthUtil.getToken(getApplicationContext(), email, "oauth2:https://www.googleapis.com/auth/userinfo.profile");
            } catch (IOException e) {
                e.printStackTrace();
    ...
    private void getProfileInformation() {
        try {
            if (Plus.PeopleApi.getCurrentPerson(mGoogleApiClient) != null) {
                ...
                Log.d("id",personId);
                String personEmail = email = Plus.AccountApi.getAccountName(mGoogleApiClient);
